...
try { 
  ...
  if ($InstallType -eq "Uninstall") {
    pause "Are you SURE you want to uninstall Minecraft: Education Edition? You'll lose all your worlds and stuff!`nPress any key to continue, or close this window."
    Clear-Host
